<div class="container-fluid py-2">
    <div class="app-header-content">
        <div class="row justify-content-between align-items-center">
            ...
            <!--//col-->
            <div class="app-search-box row col">
            ...
            <div class="app-utilities col-auto">
                <div class="app-utility-item dropdown">
                    <a class="btn btn-light btn-sm dropdown-toggle" id="user-dropdown-toggle" data-toggle="dropdown" href="#"
                        role="button" aria-expanded="false"><span>Create</span></a>
                ...
                <div class="app-utility-item app-notifications-dropdown dropdown">
                    <a class="no-toggle-arrow" id="notifications-dropdown-toggle"
                ...
                <div class="app-utility-item app-user-dropdown dropdown">
                    <a id="user-dropdown-toggle" data-toggle="dropdown" href="#"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                        <li><a class="dropdown-item fs-6" href="account.html">Signed in as<br>
                        <span class="fw-bold">Ato Augustyn</span></a></li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="account.html">Your profile</a></li>
                        <li><a class="dropdown-item" href="settings.html">Settings</a></li>
                        ...
                        <li><a class="dropdown-item" href="login.html">Support</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="login.html">Log Out</a></li>
